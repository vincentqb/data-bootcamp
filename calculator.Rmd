...
We begin by loading the packages we will need. We will need two packages to handle opening spreadsheets, two packages to tidy the data, and finally a package to help manipulate the data frames.

...
Our goal is to predict employee satisfaction in question 42, or 43.
```{r}
library(foreign)
...
```{r}
training.full <- cbind(training.num, training.fac)
testing.full <- cbind(testing.num, testing.fac)
```
